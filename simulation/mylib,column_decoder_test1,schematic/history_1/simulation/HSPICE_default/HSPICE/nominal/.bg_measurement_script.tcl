    sa::_iterativeUtils::setSkipIterations  /afs/unity.ncsu.edu/users/r/rsekani/bin/ece546/project/project/simulation/mylib,column_decoder_test1,schematic/history_1/simulation/HSPICE_default/HSPICE/nominal/results {}
    catch {wf::_scalarValueDB::setCurrentDbPath /afs/unity.ncsu.edu/users/r/rsekani/bin/ece546/project/project/simulation/mylib,column_decoder_test1,schematic/history_1/simulation/HSPICE_default/HSPICE/nominal/results "/afs/unity.ncsu.edu/users/r/rsekani/bin/ece546/project/project/simulation/mylib,column_decoder_test1,schematic/history_1/simulation/HSPICE_default/HSPICE/nominal/results/scalar_value_HSPICE_default_1_10.db"}
...
namespace eval ss {
    ...
    sa::_resultsDatabase::_loadSetupForMeasurementCalculation [getActiveTestbench] /afs/unity.ncsu.edu/users/r/rsekani/bin/ece546/project/project/simulation/mylib,column_decoder_test1,schematic/history_1/simulation/HSPICE_default/HSPICE/nominal HSPICE
    sa::_utils::setDataDir -of [getActiveTestbench] -value /afs/unity.ncsu.edu/users/r/rsekani/bin/ece546/project/project/simulation/mylib,column_decoder_test1,schematic/history_1/simulation/HSPICE_default/HSPICE/nominal 
    set session [getActiveSession]
    set sessionScope [sa::_utils::getSessionScope $session]
    set prefsFile [file join [file dirname /afs/unity.ncsu.edu/users/r/rsekani/bin/ece546/project/project/simulation/mylib,column_decoder_test1,schematic/history_1/simulation/HSPICE_default/HSPICE/nominal/results] [::sa::_coreUtils::getSavedSessionPrefsFileName]]
    set err ""
